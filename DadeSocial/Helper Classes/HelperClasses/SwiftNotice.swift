...
class SwiftNotice: NSObject {
    ...
    static let rv = UIApplication.shared.windows.filter {$0.isKeyWindow}.first
    ...
    static var degree: Double {
        get {
            return [0, 0, 180, 270, 90][UIApplication.shared.userInterfaceLayoutDirection.hashValue] as Double
        }
    }
