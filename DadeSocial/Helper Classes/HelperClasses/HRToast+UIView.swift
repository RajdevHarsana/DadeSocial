...
public extension UIView {
    ...
    class func hr_toastThemeColor() -> UIColor {
        ...
        if color == nil {
            color = UIColor(red: 246/255, green: 102/255, blue: 52/255, alpha: 1.0)
    ...
    func makeToast(message msg: String) {
        makeToast(message: msg, duration: HRToastDefaultDuration, position: center as AnyObject)//bottomAnchor
    }
